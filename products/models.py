...
from currency.models import Usd, Eur
...
class SubCategory(models.Model):
    ...
    def get_absolute_url_my(self):
        # return reverse("product_list", kwargs={"slug": self.category.slug})
...
class Product(models.Model):
    ...
    @property
    def retail_eur(self):
        eur = Eur.objects.latest('id')
        usd = Usd.objects.latest('id')
        index = usd.name / eur.name
        result = self.retail * index
