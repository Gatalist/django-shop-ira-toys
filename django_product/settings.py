...
#mail settings
RECIPIENTS_EMAIL = ['test@gmail.com']   # кому - почта
DEFAULT_FROM_EMAIL = 'test@gmail.com'  # от кого - почта
...
product_ip_page = 10 # количество продуктов на странице
news_ip_page = 10 # количество новостей на странице
